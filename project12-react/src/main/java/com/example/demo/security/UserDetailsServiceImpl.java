...
public class UserDetailsServiceImpl implements UserDetailsService {
	...
	@Override
	public UserDetails loadUserByUsername(String userNam)  { // userName는 아이디를 의미

		System.out.println("login id : " + userNam);

		// 아이디로 실제 회원정보 가져오기(조회)
		MemberDTO dto = service.read(userNam);
