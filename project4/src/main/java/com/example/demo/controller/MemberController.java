...
public class MemberController {
	...
	// 회원 폼을 반환하는 메소드
	   @GetMapping("/form") // GET 요청을 /form 주소에 매핑(/v2/form)
	...
	// 회원 등록을 처리하는 메소드
	   @PostMapping("/save") // POST 요청을 /save 경로에 매핑(/v2/save)
	    public String method2(@RequestParam(name = "username") String username, //(name = "(실제)Param 이름 ") String 변수명)
